...
def adicionar_tarefa(nome_da_task: str, descricao_da_task: str, due_date: str):
    ...
    client.list_boards()
    # Obter o board (ID e nome do board)
    boards = client.list_boards()
    meu_board = [b for b  in boards if b.name == 'AutomatedAgent'][0]
...
root_agent = Agent(
    ...
    instruction=""" 
        ...
        Suas funções:
         1. Adicionar novas tarefas com nome e decrição 
